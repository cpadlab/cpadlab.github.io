...
function createMusicCard(song) {
    return `
                <a href="${song.song_url}" target="_blank" class="mc-songs-card">
                    <div class="mc-songs-card-image">
                        <div class="mc-songs-card-hover">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path d="M0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c-7.6 4.2-12.3 12.3-12.3 20.9l0 176c0 8.7 4.7 16.7 12.3 20.9s16.8 4.1 24.3-.5l144-88c7.1-4.4 11.5-12.1 11.5-20.5s-4.4-16.1-11.5-20.5l-144-88c-7.4-4.5-16.7-4.7-24.3-.5z"/>
                            </svg>
                        </div>
                        <img src="${song.cover_page}" alt="${song.song_name} Cover Page" loading="lazy">
                    </div>
...
$(document).ready(function () {
    ...
    $.getJSON('https://cpadlab.github.io/dot-dager/src/content/projects.json', function (projects) {
        $.each(projects, function (index, project) {
            $('.github-container').append($(createProjectCard(project)));
        });
    });

    $.getJSON('https://cpadlab.github.io/dot-dager/src/content/music.json', function(data) {
        
        $.each(data, function(index, song) {
            $('.mc-songs').append($(createMusicCard(song)));
        });
